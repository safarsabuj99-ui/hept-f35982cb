          ...
          {loading ? (
            ...
            <form onSubmit={handleSaveRate} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input type="number" step="0.01" min="0.01" value={exchangeRate} onChange={(e) => setExchangeRate(e.target.value)} placeholder="120.00" required />
                <p className="text-xs text-muted-foreground">This rate is used for converting USD amounts to BDT and normalizing BDT ad spend to USD</p>
              </div>
