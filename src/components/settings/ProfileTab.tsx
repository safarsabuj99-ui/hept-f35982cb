...
const TIMEZONES = [
  "Asia/Dhaka", "Asia/Kolkata", "Asia/Dubai", "Asia/Tokyo",
    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="businessName" className="flex items-center gap-1.5"><Building2 className="h-3.5 w-3.5" /> Company / Business Name</Label>
            <Input id="businessName" value={businessName} onChange={e => setBusinessName(e.target.value)} placeholder="Your company name" maxLength={100} />
          </div>
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input id="phone" value={phone} onChange={e => setPhone(e.target.value)} placeholder="+880 1XXX-XXXXXX" maxLength={20} />
          </div>
          <div className="space-y-2">
...
function ChangePasswordCard() {
  ...
  const handleChangePassword = async () => {
    ...
    if (!user?.email) { toast.error("Unable to verify user"); setSaving(false); return; }
      ...
      <CardContent className="space-y-5">
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input id="currentPassword" type={showCurrent ? "text" : "password"} value={currentPassword} onChange={e => setCurrentPassword(e.target.value)} placeholder="Enter current password" maxLength={128} />
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <Input id="newPassword" type={showNew ? "text" : "password"} value={newPassword} onChange={e => setNewPassword(e.target.value)} placeholder="At least 8 characters" maxLength={128} />
        ...
        <div className="space-y-2">
          ...
          <Input id="confirmPassword" type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} placeholder="Re-enter new password" maxLength={128} />
        </div>
        <Button onClick={handleChangePassword} disabled={saving} className="w-full sm:w-auto">
          <Lock className="h-4 w-4 mr-2" /> {saving ? "Updating…" : "Update Password"}
        </Button>
      </CardContent>
    </Card>
  );
