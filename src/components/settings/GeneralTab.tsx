    ...
    <div className="space-y-6">
      ...
      <div className="glass-card glow-border">
        <CardHeader>
          ...
          <CardDescription>Theme and currency preferences</CardDescription>
        </CardHeader>
          ...
          <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Currently showing amounts in {currency}</p>
              </div>
            </div>
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Input type="url" value={tiktokProxyUrl} onChange={(e) => setTiktokProxyUrl(e.target.value)} placeholder="https://your-proxy.workers.dev" />
                <p className="text-xs text-muted-foreground">Leave empty for direct API calls.</p>
              </div>
